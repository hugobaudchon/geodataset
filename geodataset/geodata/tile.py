...
class Tile:
    ...
    @classmethod
    def from_path(cls, path: str or Path, tile_id):
        """
        ...
        tile_id: int
            The unique identifier that should be assigned to the tile.
...
class PolygonTile:
    ...
    def from_path(cls, path: str or Path):
        ...
        path = Path(path)
        data, metadata, product_name, ground_resolution, scale_factor, polygon_id = PolygonTile._load_tile(path)
...
class TileSaver:
    ...
    def save_all_tiles(self, tiles: List[Tile or PolygonTile]):
        ...
        Parameters
        ----------
        tiles: List[Tile or PolygonTile]
